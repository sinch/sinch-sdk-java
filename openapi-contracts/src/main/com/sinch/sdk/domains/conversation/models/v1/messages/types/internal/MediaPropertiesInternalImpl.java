...
@JsonPropertyOrder({
  MediaPropertiesInternalImpl.JSON_PROPERTY_THUMBNAIL_URL,
  MediaPropertiesInternalImpl.JSON_PROPERTY_URL,
  MediaPropertiesInternalImpl.JSON_PROPERTY_FILENAME_OVERRIDE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class MediaPropertiesInternalImpl implements MediaPropertiesInternal {
  ...
  public MediaPropertiesInternalImpl() {}

  protected MediaPropertiesInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    MediaPropertiesInternalImpl mediaProperties = (MediaPropertiesInternalImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class MediaPropertiesInternalImpl {\n");
  ...
  static class Builder implements MediaPropertiesInternal.Builder {
    ...
    public MediaPropertiesInternal build() {
      return new MediaPropertiesInternalImpl(thumbnailUrl, url, filenameOverride);
    }
  }
}
