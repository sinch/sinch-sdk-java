...
@JsonPropertyOrder({
  ListIdentityConflictsResponseInternalImpl.JSON_PROPERTY_CONFLICTS,
  ListIdentityConflictsResponseInternalImpl.JSON_PROPERTY_NEXT_PAGE_TOKEN
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ListIdentityConflictsResponseInternalImpl
    implements ListIdentityConflictsResponseInternal {
  ...
  public ListIdentityConflictsResponseInternalImpl() {}

  protected ListIdentityConflictsResponseInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    ListIdentityConflictsResponseInternalImpl contactListIdentityConflicts200Response =
        (ListIdentityConflictsResponseInternalImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class ListIdentityConflictsResponseInternalImpl {\n");
  ...
  static class Builder implements ListIdentityConflictsResponseInternal.Builder {
    ...
    public ListIdentityConflictsResponseInternal build() {
      return new ListIdentityConflictsResponseInternalImpl(conflicts, nextPageToken);
    }
  }
}
