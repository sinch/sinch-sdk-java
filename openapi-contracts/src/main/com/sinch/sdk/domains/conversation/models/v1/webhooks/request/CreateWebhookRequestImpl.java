...
@JsonPropertyOrder({
  CreateWebhookRequestImpl.JSON_PROPERTY_APP_ID,
  CreateWebhookRequestImpl.JSON_PROPERTY_CLIENT_CREDENTIALS,
  CreateWebhookRequestImpl.JSON_PROPERTY_ID,
  CreateWebhookRequestImpl.JSON_PROPERTY_SECRET,
  CreateWebhookRequestImpl.JSON_PROPERTY_TARGET,
  CreateWebhookRequestImpl.JSON_PROPERTY_TARGET_TYPE,
  CreateWebhookRequestImpl.JSON_PROPERTY_TRIGGERS
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class CreateWebhookRequestImpl implements CreateWebhookRequest {
  ...
  public CreateWebhookRequestImpl() {}

  protected CreateWebhookRequestImpl(
  ...
  public boolean equals(Object o) {
    ...
    CreateWebhookRequestImpl webhooksCreateWebhookRequest = (CreateWebhookRequestImpl) o;
  ...
  static class Builder implements CreateWebhookRequest.Builder {
    ...
    public CreateWebhookRequest build() {
      return new CreateWebhookRequestImpl(
