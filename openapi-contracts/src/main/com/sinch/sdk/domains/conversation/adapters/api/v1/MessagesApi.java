...
import com.sinch.sdk.domains.conversation.models.dto.v1.ConversationMessageDto;
import com.sinch.sdk.domains.conversation.models.dto.v1.ConversationMessagesViewDto;
import com.sinch.sdk.domains.conversation.models.dto.v1.ListMessagesResponseDto;
import com.sinch.sdk.domains.conversation.models.dto.v1.SendMessageRequestDto;
import com.sinch.sdk.domains.conversation.models.dto.v1.SendMessageResponseDto;
...
public class MessagesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ConversationMessageDto messagesGetMessage(
      String projectId, String messageId, String messagesSource) throws ApiException {
    ...
    if (HttpStatus.isSuccessfulStatus(response.getCode())) {
      TypeReference<ConversationMessageDto> localVarReturnType =
          new TypeReference<ConversationMessageDto>() {};
      return mapper.deserialize(response, localVarReturnType);
    }
    // fallback to default errors handling:
    // all error cases definition are not required from specs: will try some "hardcoded" content
   ...
   * @throws ApiException if fails to make API call
   */
  public ListMessagesResponseDto messagesListMessages(
      String projectId,
      ...
      Integer pageSize,
      String pageToken,
      ConversationMessagesViewDto view,
    ...
    if (HttpStatus.isSuccessfulStatus(response.getCode())) {
      TypeReference<ListMessagesResponseDto> localVarReturnType =
          new TypeReference<ListMessagesResponseDto>() {};
      return mapper.deserialize(response, localVarReturnType);
    }
    // fallback to default errors handling:
    // all error cases definition are not required from specs: will try some "hardcoded" content
   ...
   * Dashboard](https://dashboard.sinch.com/convapi/overview).
   *
   * @param projectId The unique ID of the project. You can find this on the [Sinch
   *     Dashboard](https://dashboard.sinch.com/convapi/apps). (required)
   * @param sendMessageRequestDto This is the request body for sending a message.
   *     &#x60;app_id&#x60;, &#x60;recipient&#x60;, and &#x60;message&#x60; are all required fields.
   *     (required)
   * @return SendMessageResponseDto
   * @throws ApiException if fails to make API call
   */
  public SendMessageResponseDto messagesSendMessage(
      String projectId, SendMessageRequestDto sendMessageRequestDto) throws ApiException {
    ...
    HttpRequest httpRequest = messagesSendMessageRequestBuilder(projectId, sendMessageRequestDto);
    HttpResponse response =
        httpClient.invokeAPI(
            this.serverConfiguration, this.authManagersByOasSecuritySchemes, httpRequest);

    if (HttpStatus.isSuccessfulStatus(response.getCode())) {
      TypeReference<SendMessageResponseDto> localVarReturnType =
  ...
  private HttpRequest messagesSendMessageRequestBuilder(
    ...
    if (sendMessageRequestDto == null) {
      throw new ApiException(
          400,
          "Missing the required parameter 'sendMessageRequestDto' when calling"
              + " messagesSendMessage");
    }
    ...
    final Collection<String> localVarAuthNames = Arrays.asList("Basic", "oAuth2");
    final String serializedBody = mapper.serialize(localVarContentTypes, sendMessageRequestDto);
