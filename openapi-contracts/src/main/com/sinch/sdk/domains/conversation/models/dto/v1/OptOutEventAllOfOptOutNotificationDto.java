...
/** OptOutEventAllOfOptOutNotificationDto */
@JsonPropertyOrder({
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_REQUEST_ID,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_CONTACT_ID,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_CHANNEL,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_IDENTITY,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_STATUS,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_ERROR_DETAILS,
  OptOutEventAllOfOptOutNotificationDto.JSON_PROPERTY_PROCESSING_MODE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class OptOutEventAllOfOptOutNotificationDto {
  ...
  public enum StatusEnum {
    SUCCEEDED("OPT_OUT_SUCCEEDED"),

    FAILED("OPT_OUT_FAILED"),

    STATUS_UNSPECIFIED("OPT_OUT_STATUS_UNSPECIFIED"),
  ...
  private OptOutEventAllOfOptOutNotificationErrorDetailsDto errorDetails;
  ...
  public OptOutEventAllOfOptOutNotificationDto() {}

  public OptOutEventAllOfOptOutNotificationDto requestId(String requestId) {
  ...
  public OptOutEventAllOfOptOutNotificationDto contactId(String contactId) {
  ...
  /**
   * The ID of the contact which is the subject of the opt-out. Will be empty if processing_mode is
   * DISPATCH.
   *
   * @return contactId
   */
  ...
  public OptOutEventAllOfOptOutNotificationDto channel(ConversationChannelDto channel) {
  ...
  public OptOutEventAllOfOptOutNotificationDto identity(String identity) {
  ...
  public OptOutEventAllOfOptOutNotificationDto status(String status) {
    this.status = status;
  ...
  public OptOutEventAllOfOptOutNotificationDto errorDetails(
      OptOutEventAllOfOptOutNotificationErrorDetailsDto errorDetails) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptOutEventAllOfOptOutNotificationErrorDetailsDto getErrorDetails() {
    return errorDetails;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setErrorDetails(OptOutEventAllOfOptOutNotificationErrorDetailsDto errorDetails) {
    this.errorDetails = errorDetails;
    this.errorDetailsDefined = true;
  }

  public OptOutEventAllOfOptOutNotificationDto processingMode(ProcessingModeDto processingMode) {
  ...
  public boolean equals(Object o) {
    ...
    OptOutEventAllOfOptOutNotificationDto optOutEventAllOfOptOutNotification =
        (OptOutEventAllOfOptOutNotificationDto) o;
  ...
  public String toString() {
    ...
    sb.append("class OptOutEventAllOfOptOutNotificationDto {\n");
