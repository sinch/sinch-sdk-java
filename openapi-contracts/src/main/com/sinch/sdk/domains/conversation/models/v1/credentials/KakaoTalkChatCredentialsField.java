...
/** declaration */
@JsonDeserialize(builder = KakaoTalkChatCredentialsFieldImpl.Builder.class)
public interface KakaoTalkChatCredentialsField {
  ...
  static Builder builder() {
    return new KakaoTalkChatCredentialsFieldImpl.Builder();
  }
  ...
  interface Builder {
     ...
     */
    KakaoTalkChatCredentialsField build();
  }
}
