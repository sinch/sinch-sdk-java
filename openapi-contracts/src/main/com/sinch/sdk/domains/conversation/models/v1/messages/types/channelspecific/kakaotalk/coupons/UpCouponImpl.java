...
@JsonPropertyOrder({
  UpCouponImpl.JSON_PROPERTY_TYPE,
  UpCouponImpl.JSON_PROPERTY_DESCRIPTION,
  UpCouponImpl.JSON_PROPERTY_LINK_MO,
  UpCouponImpl.JSON_PROPERTY_LINK_PC,
  UpCouponImpl.JSON_PROPERTY_SCHEME_ANDROID,
  UpCouponImpl.JSON_PROPERTY_SCHEME_IOS,
  UpCouponImpl.JSON_PROPERTY_TITLE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class UpCouponImpl
    implements UpCoupon,
  ...
  /** Return true if this KakaoTalkUpCoupon object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    UpCouponImpl kakaoTalkUpCoupon = (UpCouponImpl) o;
    return Objects.equals(this.type, kakaoTalkUpCoupon.type)
        && Objects.equals(this.description, kakaoTalkUpCoupon.description)
        && Objects.equals(this.linkMo, kakaoTalkUpCoupon.linkMo)
        && Objects.equals(this.linkPc, kakaoTalkUpCoupon.linkPc)
        && Objects.equals(this.schemeAndroid, kakaoTalkUpCoupon.schemeAndroid)
        && Objects.equals(this.schemeIos, kakaoTalkUpCoupon.schemeIos)
        && Objects.equals(this.title, kakaoTalkUpCoupon.title);
  }
  ...
  static class Builder implements UpCoupon.Builder {
    OptionalValue<TypeEnum> type = OptionalValue.of(TypeEnum.UP_COUPON);
    ...
    Builder setType(TypeEnum type) {
      if (!Objects.equals(type, TypeEnum.UP_COUPON)) {
        throw new IllegalArgumentException(
            String.format("'type' must be '%s' (is '%s')", TypeEnum.UP_COUPON, type));
      }
      return this;
    }
    ...
    public UpCoupon build() {
      return new UpCouponImpl(type, description, linkMo, linkPc, schemeAndroid, schemeIos, title);
    }
  }
}
