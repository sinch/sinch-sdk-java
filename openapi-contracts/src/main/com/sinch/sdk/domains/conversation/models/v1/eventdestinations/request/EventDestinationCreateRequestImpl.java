...
import com.sinch.sdk.domains.conversation.models.v1.eventdestinations.ClientCredentials;
...
@JsonPropertyOrder({
  EventDestinationCreateRequestImpl.JSON_PROPERTY_APP_ID,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_CLIENT_CREDENTIALS,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_ID,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_SECRET,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_TARGET,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_TARGET_TYPE,
  EventDestinationCreateRequestImpl.JSON_PROPERTY_TRIGGERS
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class EventDestinationCreateRequestImpl implements EventDestinationCreateRequest {
  ...
  private OptionalValue<EventDestinationTargetType> targetType;

  public static final String JSON_PROPERTY_TRIGGERS = "triggers";

  private OptionalValue<List<EventDestinationTrigger>> triggers;

  public EventDestinationCreateRequestImpl() {}

  protected EventDestinationCreateRequestImpl(
      ...
      OptionalValue<EventDestinationTargetType> targetType,
      OptionalValue<List<EventDestinationTrigger>> triggers) {
    this.appId = appId;
  ...
  @JsonIgnore
  public EventDestinationTargetType getTargetType() {
    return targetType.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TARGET_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<EventDestinationTargetType> targetType() {
    return targetType;
  }

  @JsonIgnore
  public List<EventDestinationTrigger> getTriggers() {
    return triggers.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TRIGGERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<List<EventDestinationTrigger>> triggers() {
    return triggers;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventDestinationCreateRequestImpl webhooksCreateWebhookRequest =
        (EventDestinationCreateRequestImpl) o;
  ...
  static class Builder implements EventDestinationCreateRequest.Builder {
    ...
    OptionalValue<EventDestinationTargetType> targetType = OptionalValue.empty();
    OptionalValue<List<EventDestinationTrigger>> triggers = OptionalValue.empty();
    ...
    @JsonProperty(JSON_PROPERTY_TARGET_TYPE)
    public Builder setTargetType(EventDestinationTargetType targetType) {
      this.targetType = OptionalValue.of(targetType);
      return this;
    }

    @JsonProperty(JSON_PROPERTY_TRIGGERS)
    public Builder setTriggers(List<EventDestinationTrigger> triggers) {
      this.triggers = OptionalValue.of(triggers);
      return this;
    }

    public EventDestinationCreateRequest build() {
      return new EventDestinationCreateRequestImpl(
