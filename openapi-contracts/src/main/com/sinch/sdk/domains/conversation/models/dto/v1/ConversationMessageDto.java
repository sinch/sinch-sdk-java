...
public class ConversationMessageDto {
  ...
  /**
   * For Contact Messages the sender ID that the contact sent the message to. For App Messages the
  ...
  public ConversationMessageDto messageStatus(MessageStatusDto messageStatus) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public MessageStatusDto getMessageStatus() {
    return messageStatus;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessageStatus(MessageStatusDto messageStatus) {
    this.messageStatus = messageStatus;
    this.messageStatusDefined = true;
  }
