...
@JsonPropertyOrder({
  CapabilityEventDto.JSON_PROPERTY_APP_ID,
  CapabilityEventDto.JSON_PROPERTY_ACCEPTED_TIME,
  CapabilityEventDto.JSON_PROPERTY_EVENT_TIME,
  CapabilityEventDto.JSON_PROPERTY_PROJECT_ID,
  CapabilityEventDto.JSON_PROPERTY_MESSAGE_METADATA,
  CapabilityEventDto.JSON_PROPERTY_CORRELATION_ID,
  CapabilityEventDto.JSON_PROPERTY_CAPABILITY_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class CapabilityEventDto {
  ...
  private CapabilityEventAllOfCapabilityNotificationDto capabilityNotification;
  private boolean capabilityNotificationDefined = false;

  public CapabilityEventDto() {}

  public CapabilityEventDto appId(String appId) {
    this.appId = appId;
  ...
  public CapabilityEventDto acceptedTime(LocalDate acceptedTime) {
  ...
  public CapabilityEventDto eventTime(LocalDate eventTime) {
  ...
  public CapabilityEventDto projectId(String projectId) {
  ...
  public CapabilityEventDto messageMetadata(String messageMetadata) {
  ...
  public CapabilityEventDto correlationId(String correlationId) {
  ...
  public CapabilityEventDto capabilityNotification(
      CapabilityEventAllOfCapabilityNotificationDto capabilityNotification) {
    this.capabilityNotification = capabilityNotification;
    this.capabilityNotificationDefined = true;
    return this;
  }

  /**
   * Get capabilityNotification
   *
   * @return capabilityNotification
   */
  @JsonProperty(JSON_PROPERTY_CAPABILITY_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public CapabilityEventAllOfCapabilityNotificationDto getCapabilityNotification() {
    return capabilityNotification;
  }

  @JsonIgnore
  public boolean getCapabilityNotificationDefined() {
    return capabilityNotificationDefined;
  }

  @JsonProperty(JSON_PROPERTY_CAPABILITY_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCapabilityNotification(
      CapabilityEventAllOfCapabilityNotificationDto capabilityNotification) {
    this.capabilityNotification = capabilityNotification;
    this.capabilityNotificationDefined = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    CapabilityEventDto capabilityEvent = (CapabilityEventDto) o;
    return Objects.equals(this.appId, capabilityEvent.appId)
        ...
        && Objects.equals(this.capabilityNotification, capabilityEvent.capabilityNotification);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapabilityEventDto {\n");
    ...
    sb.append("    capabilityNotification: ")
        .append(toIndentedString(capabilityNotification))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
