...
/** declaration */
@JsonDeserialize(builder = CallMessageCallMessageImpl.Builder.class)
public interface CallMessageCallMessage {
  ...
  static Builder builder() {
    return new CallMessageCallMessageImpl.Builder();
  }
