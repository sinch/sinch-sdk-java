...
@JsonPropertyOrder({
  EventsListResponseInternalImpl.JSON_PROPERTY_EVENTS,
  EventsListResponseInternalImpl.JSON_PROPERTY_NEXT_PAGE_TOKEN
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class EventsListResponseInternalImpl implements EventsListResponseInternal {
  ...
  protected EventsListResponseInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    EventsListResponseInternalImpl listEventsResponse = (EventsListResponseInternalImpl) o;
  ...
  static class Builder implements EventsListResponseInternal.Builder {
    ...
    public EventsListResponseInternal build() {
      return new EventsListResponseInternalImpl(events, nextPageToken);
    }
  }
}
