...
@JsonPropertyOrder({
  OptInEventDto.JSON_PROPERTY_APP_ID,
  OptInEventDto.JSON_PROPERTY_ACCEPTED_TIME,
  OptInEventDto.JSON_PROPERTY_EVENT_TIME,
  OptInEventDto.JSON_PROPERTY_PROJECT_ID,
  OptInEventDto.JSON_PROPERTY_MESSAGE_METADATA,
  OptInEventDto.JSON_PROPERTY_CORRELATION_ID,
  OptInEventDto.JSON_PROPERTY_OPT_IN_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class OptInEventDto {
  ...
  private OptInEventAllOfOptInNotificationDto optInNotification;
  private boolean optInNotificationDefined = false;

  public OptInEventDto() {}

  public OptInEventDto appId(String appId) {
    this.appId = appId;
  ...
  public OptInEventDto acceptedTime(LocalDate acceptedTime) {
  ...
  public OptInEventDto eventTime(LocalDate eventTime) {
  ...
  public OptInEventDto projectId(String projectId) {
  ...
  public OptInEventDto messageMetadata(String messageMetadata) {
  ...
  public OptInEventDto correlationId(String correlationId) {
  ...
  public OptInEventDto optInNotification(OptInEventAllOfOptInNotificationDto optInNotification) {
    this.optInNotification = optInNotification;
    this.optInNotificationDefined = true;
    return this;
  }

  /**
   * Get optInNotification
   *
   * @return optInNotification
   */
  @JsonProperty(JSON_PROPERTY_OPT_IN_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptInEventAllOfOptInNotificationDto getOptInNotification() {
    return optInNotification;
  }

  @JsonIgnore
  public boolean getOptInNotificationDefined() {
    return optInNotificationDefined;
  }

  @JsonProperty(JSON_PROPERTY_OPT_IN_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptInNotification(OptInEventAllOfOptInNotificationDto optInNotification) {
    this.optInNotification = optInNotification;
    this.optInNotificationDefined = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    OptInEventDto optInEvent = (OptInEventDto) o;
    return Objects.equals(this.appId, optInEvent.appId)
        ...
        && Objects.equals(this.optInNotification, optInEvent.optInNotification);
  }
  ...
  public String toString() {
    ...
    sb.append("    optInNotification: ").append(toIndentedString(optInNotification)).append("\n");
    sb.append("}");
    return sb.toString();
  }
