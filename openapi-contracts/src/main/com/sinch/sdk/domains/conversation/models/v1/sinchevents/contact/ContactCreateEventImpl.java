...
@JsonPropertyOrder({
  ContactCreateEventImpl.JSON_PROPERTY_APP_ID,
  ContactCreateEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  ContactCreateEventImpl.JSON_PROPERTY_EVENT_TIME,
  ContactCreateEventImpl.JSON_PROPERTY_PROJECT_ID,
  ContactCreateEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  ContactCreateEventImpl.JSON_PROPERTY_CORRELATION_ID,
  ContactCreateEventImpl.JSON_PROPERTY_CONTACT_CREATE_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ContactCreateEventImpl
    implements ContactCreateEvent,
  ...
  public static final String JSON_PROPERTY_CONTACT_CREATE_NOTIFICATION =
      "contact_create_notification";

  private OptionalValue<ContactNotification> notification;

  public ContactCreateEventImpl() {}

  protected ContactCreateEventImpl(
      ...
      OptionalValue<ContactNotification> notification) {
    this.appId = appId;
  ...
  @JsonIgnore
  public ContactNotification getNotification() {
    return notification.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CONTACT_CREATE_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<ContactNotification> notification() {
    return notification;
  }

  /** Return true if this ContactCreateEvent object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ContactCreateEventImpl contactCreateEvent = (ContactCreateEventImpl) o;
    return Objects.equals(this.appId, contactCreateEvent.appId)
        && Objects.equals(this.acceptedTime, contactCreateEvent.acceptedTime)
        && Objects.equals(this.eventTime, contactCreateEvent.eventTime)
        && Objects.equals(this.projectId, contactCreateEvent.projectId)
        && Objects.equals(this.messageMetadata, contactCreateEvent.messageMetadata)
        && Objects.equals(this.correlationId, contactCreateEvent.correlationId)
        && Objects.equals(this.notification, contactCreateEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactCreateEventImpl {\n");
  ...
  static class Builder implements ContactCreateEvent.Builder {
    ...
    @JsonProperty(value = JSON_PROPERTY_CONTACT_CREATE_NOTIFICATION, required = true)
    public Builder setNotification(ContactNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public ContactCreateEvent build() {
      return new ContactCreateEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
