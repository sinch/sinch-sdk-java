...
@JsonPropertyOrder({
  ...
  AppUpdateRequestDto.JSON_PROPERTY_SMART_CONVERSATION,
  AppUpdateRequestDto.JSON_PROPERTY_CALLBACK_SETTINGS
})
...
public class AppUpdateRequestDto {
  ...
  public AppUpdateRequestDto addChannelCredentialsItem(
  ...
  public AppUpdateRequestDto conversationMetadataReportView(
  ...
  public AppUpdateRequestDto dispatchRetentionPolicy(
  ...
  public AppUpdateRequestDto processingMode(ProcessingModeDto processingMode) {
  ...
  public AppUpdateRequestDto smartConversation(SmartConversationDto smartConversation) {
  ...
  public AppUpdateRequestDto callbackSettings(CallbackSettingsDto callbackSettings) {
