...
@JsonPropertyOrder({
  OrderStatusImpl.JSON_PROPERTY_HEADER,
  OrderStatusImpl.JSON_PROPERTY_BODY,
  OrderStatusImpl.JSON_PROPERTY_FOOTER,
  OrderStatusImpl.JSON_PROPERTY_PAYMENT
})
...
public class OrderStatusImpl
  ...
  private OptionalValue<OrderStatusPayment> payment;
  ...
  protected OrderStatusImpl(
      ...
      OptionalValue<OrderStatusPayment> payment) {
    this.header = header;
    this.body = body;
    this.footer = footer;
  ...
  @JsonIgnore
  public OrderStatusPayment getPayment() {
    return payment.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_PAYMENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public OptionalValue<OrderStatusPayment> payment() {
    return payment;
  }

  /** Return true if this PaymentOrderStatusChannelSpecificMessage object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    OrderStatusImpl paymentOrderStatusChannelSpecificMessage = (OrderStatusImpl) o;
    return Objects.equals(this.header, paymentOrderStatusChannelSpecificMessage.header)
        && Objects.equals(this.body, paymentOrderStatusChannelSpecificMessage.body)
        && Objects.equals(this.footer, paymentOrderStatusChannelSpecificMessage.footer)
        && Objects.equals(this.payment, paymentOrderStatusChannelSpecificMessage.payment);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderStatusImpl {\n");
  ...
  static class Builder implements OrderStatus.Builder {
    ...
    OptionalValue<OrderStatusPayment> payment = OptionalValue.empty();
    ...
    public Builder setPayment(OrderStatusPayment payment) {
      this.payment = OptionalValue.of(payment);
      return this;
    }

    public OrderStatus build() {
      return new OrderStatusImpl(header, body, footer, payment);
    }
  }
}
