...
/** declaration */
@JsonDeserialize(builder = CardMessageCardMessageImpl.Builder.class)
public interface CardMessageCardMessage {
   ...
   * @return mediaMessage
   */
  MediaCarouselMessage getMediaMessage();
  ...
  static Builder builder() {
    return new CardMessageCardMessageImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getMediaMessage
     */
    Builder setMediaMessage(MediaCarouselMessage mediaMessage);
