...
@JsonPropertyOrder({ListTemplatesResponseInternalImpl.JSON_PROPERTY_TEMPLATES})
...
public class ListTemplatesResponseInternalImpl implements ListTemplatesResponseInternal {
  ...
  protected ListTemplatesResponseInternalImpl(OptionalValue<List<TemplateV2>> templates) {
  ...
  public boolean equals(Object o) {
    ...
    ListTemplatesResponseInternalImpl v2ListTemplatesResponse =
  ...
  static class Builder implements ListTemplatesResponseInternal.Builder {
    ...
    public ListTemplatesResponseInternal build() {
      return new ListTemplatesResponseInternalImpl(templates);
    }
  }
}
