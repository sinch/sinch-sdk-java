...
@JsonDeserialize(builder = EventDestinationCreateRequestImpl.Builder.class)
public interface EventDestinationCreateRequest {
   ...
   * @return targetType
   */
  EventDestinationTargetType getTargetType();
   ...
   * @return triggers
   */
  List<EventDestinationTrigger> getTriggers();
  ...
  static Builder builder() {
    return new EventDestinationCreateRequestImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getTargetType
     */
    Builder setTargetType(EventDestinationTargetType targetType);
     ...
     * @see #getTriggers
     */
    Builder setTriggers(List<EventDestinationTrigger> triggers);
     ...
     */
    EventDestinationCreateRequest build();
  }
}
