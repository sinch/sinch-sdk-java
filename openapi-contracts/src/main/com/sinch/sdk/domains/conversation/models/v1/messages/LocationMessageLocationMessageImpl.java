...
@JsonPropertyOrder({
  LocationMessageLocationMessageImpl.JSON_PROPERTY_COORDINATES,
  LocationMessageLocationMessageImpl.JSON_PROPERTY_LABEL,
  LocationMessageLocationMessageImpl.JSON_PROPERTY_TITLE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class LocationMessageLocationMessageImpl implements LocationMessageLocationMessage {
  ...
  public LocationMessageLocationMessageImpl() {}

  protected LocationMessageLocationMessageImpl(
  ...
  public boolean equals(Object o) {
    ...
    LocationMessageLocationMessageImpl locationMessageLocationMessage =
        (LocationMessageLocationMessageImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class LocationMessageLocationMessageImpl {\n");
  ...
  static class Builder implements LocationMessageLocationMessage.Builder {
    ...
    public LocationMessageLocationMessage build() {
      return new LocationMessageLocationMessageImpl(coordinates, label, title);
    }
  }
}
