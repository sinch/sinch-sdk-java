...
@JsonPropertyOrder({
  ConversationDeleteEventImpl.JSON_PROPERTY_APP_ID,
  ConversationDeleteEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  ConversationDeleteEventImpl.JSON_PROPERTY_EVENT_TIME,
  ConversationDeleteEventImpl.JSON_PROPERTY_PROJECT_ID,
  ConversationDeleteEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  ConversationDeleteEventImpl.JSON_PROPERTY_CORRELATION_ID,
  ConversationDeleteEventImpl.JSON_PROPERTY_CONVERSATION_DELETE_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ConversationDeleteEventImpl
    implements ConversationDeleteEvent,
  ...
  public static final String JSON_PROPERTY_CONVERSATION_DELETE_NOTIFICATION =
      "conversation_delete_notification";

  private OptionalValue<ConversationNotification> notification;

  public ConversationDeleteEventImpl() {}

  protected ConversationDeleteEventImpl(
      ...
      OptionalValue<ConversationNotification> notification) {
    this.appId = appId;
  ...
  @JsonIgnore
  public ConversationNotification getNotification() {
    return notification.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CONVERSATION_DELETE_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<ConversationNotification> notification() {
    return notification;
  }

  /** Return true if this ConversationDeleteEvent object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ConversationDeleteEventImpl conversationDeleteEvent = (ConversationDeleteEventImpl) o;
    return Objects.equals(this.appId, conversationDeleteEvent.appId)
        && Objects.equals(this.acceptedTime, conversationDeleteEvent.acceptedTime)
        && Objects.equals(this.eventTime, conversationDeleteEvent.eventTime)
        && Objects.equals(this.projectId, conversationDeleteEvent.projectId)
        && Objects.equals(this.messageMetadata, conversationDeleteEvent.messageMetadata)
        && Objects.equals(this.correlationId, conversationDeleteEvent.correlationId)
        && Objects.equals(this.notification, conversationDeleteEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationDeleteEventImpl {\n");
  ...
  static class Builder implements ConversationDeleteEvent.Builder {
    ...
    OptionalValue<ConversationNotification> notification = OptionalValue.empty();
    ...
    @JsonProperty(value = JSON_PROPERTY_CONVERSATION_DELETE_NOTIFICATION, required = true)
    public Builder setNotification(ConversationNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public ConversationDeleteEvent build() {
      return new ConversationDeleteEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
