...
@JsonPropertyOrder({
  ContactsListResponseInternalImpl.JSON_PROPERTY_CONTACTS,
  ContactsListResponseInternalImpl.JSON_PROPERTY_NEXT_PAGE_TOKEN
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ContactsListResponseInternalImpl implements ContactsListResponseInternal {
  ...
  public ContactsListResponseInternalImpl() {}

  protected ContactsListResponseInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    ContactsListResponseInternalImpl listContactsResponse = (ContactsListResponseInternalImpl) o;
  ...
  static class Builder implements ContactsListResponseInternal.Builder {
    ...
    public ContactsListResponseInternal build() {
      return new ContactsListResponseInternalImpl(contacts, nextPageToken);
    }
  }
}
