...
@JsonDeserialize(builder = TemplateReferenceWithVersionInternalImpl.Builder.class)
public interface TemplateReferenceWithVersionInternal {
  ...
  static Builder builder() {
    return new TemplateReferenceWithVersionInternalImpl.Builder();
  }
  ...
  interface Builder {
     ...
     */
    TemplateReferenceWithVersionInternal build();
  }
}
