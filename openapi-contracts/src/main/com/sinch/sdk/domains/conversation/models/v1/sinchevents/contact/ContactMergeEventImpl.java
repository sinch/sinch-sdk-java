...
@JsonPropertyOrder({
  ContactMergeEventImpl.JSON_PROPERTY_APP_ID,
  ContactMergeEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  ContactMergeEventImpl.JSON_PROPERTY_EVENT_TIME,
  ContactMergeEventImpl.JSON_PROPERTY_PROJECT_ID,
  ContactMergeEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  ContactMergeEventImpl.JSON_PROPERTY_CORRELATION_ID,
  ContactMergeEventImpl.JSON_PROPERTY_CONTACT_MERGE_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ContactMergeEventImpl
    implements ContactMergeEvent,
  ...
  public static final String JSON_PROPERTY_CONTACT_MERGE_NOTIFICATION =
      "contact_merge_notification";

  private OptionalValue<ContactMergeEventNotification> notification;

  public ContactMergeEventImpl() {}

  protected ContactMergeEventImpl(
      ...
      OptionalValue<ContactMergeEventNotification> notification) {
    this.appId = appId;
  ...
  @JsonIgnore
  public ContactMergeEventNotification getNotification() {
    return notification.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CONTACT_MERGE_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<ContactMergeEventNotification> notification() {
    return notification;
  }

  /** Return true if this ContactMergeEvent object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ContactMergeEventImpl contactMergeEvent = (ContactMergeEventImpl) o;
    return Objects.equals(this.appId, contactMergeEvent.appId)
        && Objects.equals(this.acceptedTime, contactMergeEvent.acceptedTime)
        && Objects.equals(this.eventTime, contactMergeEvent.eventTime)
        && Objects.equals(this.projectId, contactMergeEvent.projectId)
        && Objects.equals(this.messageMetadata, contactMergeEvent.messageMetadata)
        && Objects.equals(this.correlationId, contactMergeEvent.correlationId)
        && Objects.equals(this.notification, contactMergeEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactMergeEventImpl {\n");
  ...
  static class Builder implements ContactMergeEvent.Builder {
    ...
    OptionalValue<ContactMergeEventNotification> notification = OptionalValue.empty();
    ...
    @JsonProperty(value = JSON_PROPERTY_CONTACT_MERGE_NOTIFICATION, required = true)
    public Builder setNotification(ContactMergeEventNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public ContactMergeEvent build() {
      return new ContactMergeEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
