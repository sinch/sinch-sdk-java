...
@JsonPropertyOrder({
  ConversationStopEventImpl.JSON_PROPERTY_APP_ID,
  ConversationStopEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  ConversationStopEventImpl.JSON_PROPERTY_EVENT_TIME,
  ConversationStopEventImpl.JSON_PROPERTY_PROJECT_ID,
  ConversationStopEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  ConversationStopEventImpl.JSON_PROPERTY_CORRELATION_ID,
  ConversationStopEventImpl.JSON_PROPERTY_CONVERSATION_STOP_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ConversationStopEventImpl
    implements ConversationStopEvent,
  ...
  public ConversationStopEventImpl() {}

  protected ConversationStopEventImpl(
  ...
  public boolean equals(Object o) {
    ...
    ConversationStopEventImpl conversationStopEvent = (ConversationStopEventImpl) o;
    return Objects.equals(this.appId, conversationStopEvent.appId)
        ...
        && Objects.equals(this.notification, conversationStopEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationStopEventImpl {\n");
  ...
  static class Builder implements ConversationStopEvent.Builder {
    ...
    @JsonProperty(value = JSON_PROPERTY_CONVERSATION_STOP_NOTIFICATION, required = true)
    public Builder setNotification(ConversationNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public ConversationStopEvent build() {
      return new ConversationStopEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
