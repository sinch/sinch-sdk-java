...
@JsonDeserialize(builder = OptOutEventImpl.Builder.class)
public interface OptOutEvent
   ...
   * @return notification
   */
  OptOutEventNotification getNotification();
  ...
  static Builder builder() {
    return new OptOutEventImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getNotification
     */
    Builder setNotification(OptOutEventNotification notification);
