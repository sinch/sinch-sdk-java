...
@JsonPropertyOrder({
  OptOutEventImpl.JSON_PROPERTY_APP_ID,
  OptOutEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  OptOutEventImpl.JSON_PROPERTY_EVENT_TIME,
  OptOutEventImpl.JSON_PROPERTY_PROJECT_ID,
  OptOutEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  OptOutEventImpl.JSON_PROPERTY_CORRELATION_ID,
  OptOutEventImpl.JSON_PROPERTY_OPT_OUT_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class OptOutEventImpl
    implements OptOutEvent,
  ...
  private OptionalValue<OptOutEventNotification> notification;

  public OptOutEventImpl() {}

  protected OptOutEventImpl(
      ...
      OptionalValue<OptOutEventNotification> notification) {
    this.appId = appId;
  ...
  @JsonIgnore
  public OptOutEventNotification getNotification() {
    return notification.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_OPT_OUT_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<OptOutEventNotification> notification() {
    return notification;
  }
  ...
  public boolean equals(Object o) {
    ...
    OptOutEventImpl optOutEvent = (OptOutEventImpl) o;
    return Objects.equals(this.appId, optOutEvent.appId)
        ...
        && Objects.equals(this.notification, optOutEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OptOutEventImpl {\n");
  ...
  static class Builder implements OptOutEvent.Builder {
    ...
    OptionalValue<OptOutEventNotification> notification = OptionalValue.empty();
    ...
    @JsonProperty(value = JSON_PROPERTY_OPT_OUT_NOTIFICATION, required = true)
    public Builder setNotification(OptOutEventNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public OptOutEvent build() {
      return new OptOutEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
