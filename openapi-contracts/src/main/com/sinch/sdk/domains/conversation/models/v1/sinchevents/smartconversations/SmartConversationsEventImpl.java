...
@JsonPropertyOrder({
  SmartConversationsEventImpl.JSON_PROPERTY_APP_ID,
  SmartConversationsEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  SmartConversationsEventImpl.JSON_PROPERTY_EVENT_TIME,
  SmartConversationsEventImpl.JSON_PROPERTY_PROJECT_ID,
  SmartConversationsEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  SmartConversationsEventImpl.JSON_PROPERTY_CORRELATION_ID,
  SmartConversationsEventImpl.JSON_PROPERTY_SMART_CONVERSATION_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class SmartConversationsEventImpl
    implements SmartConversationsEvent,
        com.sinch.sdk.domains.conversation.models.v1.sinchevents.ConversationSinchEvent {
  ...
  public static final String JSON_PROPERTY_SMART_CONVERSATION_NOTIFICATION =
      "smart_conversation_notification";

  private OptionalValue<SmartConversationsEventNotification> notification;

  public SmartConversationsEventImpl() {}

  protected SmartConversationsEventImpl(
      ...
      OptionalValue<SmartConversationsEventNotification> notification) {
    this.appId = appId;
  ...
  @JsonIgnore
  public SmartConversationsEventNotification getNotification() {
    return notification.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_SMART_CONVERSATION_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionalValue<SmartConversationsEventNotification> notification() {
    return notification;
  }

  /** Return true if this SmartConversationsEvent object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    SmartConversationsEventImpl smartConversationsEvent = (SmartConversationsEventImpl) o;
    return Objects.equals(this.appId, smartConversationsEvent.appId)
        && Objects.equals(this.acceptedTime, smartConversationsEvent.acceptedTime)
        && Objects.equals(this.eventTime, smartConversationsEvent.eventTime)
        && Objects.equals(this.projectId, smartConversationsEvent.projectId)
        && Objects.equals(this.messageMetadata, smartConversationsEvent.messageMetadata)
        && Objects.equals(this.correlationId, smartConversationsEvent.correlationId)
        && Objects.equals(this.notification, smartConversationsEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmartConversationsEventImpl {\n");
  ...
  static class Builder implements SmartConversationsEvent.Builder {
    ...
    OptionalValue<SmartConversationsEventNotification> notification = OptionalValue.empty();
    ...
    @JsonProperty(value = JSON_PROPERTY_SMART_CONVERSATION_NOTIFICATION, required = true)
    public Builder setNotification(SmartConversationsEventNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public SmartConversationsEvent build() {
      return new SmartConversationsEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
