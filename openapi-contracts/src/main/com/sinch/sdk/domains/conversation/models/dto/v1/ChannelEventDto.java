 ...
 */
@JsonPropertyOrder({
  ChannelEventDto.JSON_PROPERTY_APP_ID,
  ChannelEventDto.JSON_PROPERTY_ACCEPTED_TIME,
  ChannelEventDto.JSON_PROPERTY_EVENT_TIME,
  ChannelEventDto.JSON_PROPERTY_PROJECT_ID,
  ChannelEventDto.JSON_PROPERTY_MESSAGE_METADATA,
  ChannelEventDto.JSON_PROPERTY_CORRELATION_ID,
  ChannelEventDto.JSON_PROPERTY_CHANNEL_EVENT_NOTIFICATION
})
...
public class ChannelEventDto {
  ...
  private ChannelEventAllOfChannelEventNotificationDto channelEventNotification;
  private boolean channelEventNotificationDefined = false;

  public ChannelEventDto() {}

  public ChannelEventDto appId(String appId) {
    this.appId = appId;
  ...
  public ChannelEventDto acceptedTime(LocalDate acceptedTime) {
  ...
  public ChannelEventDto eventTime(LocalDate eventTime) {
  ...
  public ChannelEventDto projectId(String projectId) {
  ...
  public ChannelEventDto messageMetadata(String messageMetadata) {
  ...
  public ChannelEventDto correlationId(String correlationId) {
  ...
  public ChannelEventDto channelEventNotification(
      ChannelEventAllOfChannelEventNotificationDto channelEventNotification) {
    this.channelEventNotification = channelEventNotification;
    this.channelEventNotificationDefined = true;
    return this;
  }

  /**
   * Get channelEventNotification
   *
   * @return channelEventNotification
   */
  @JsonProperty(JSON_PROPERTY_CHANNEL_EVENT_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ChannelEventAllOfChannelEventNotificationDto getChannelEventNotification() {
    return channelEventNotification;
  }

  @JsonIgnore
  public boolean getChannelEventNotificationDefined() {
    return channelEventNotificationDefined;
  }

  @JsonProperty(JSON_PROPERTY_CHANNEL_EVENT_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChannelEventNotification(
      ChannelEventAllOfChannelEventNotificationDto channelEventNotification) {
    this.channelEventNotification = channelEventNotification;
    this.channelEventNotificationDefined = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChannelEventDto channelEvent = (ChannelEventDto) o;
    return Objects.equals(this.appId, channelEvent.appId)
        ...
        && Objects.equals(this.channelEventNotification, channelEvent.channelEventNotification);
  }
  ...
  public String toString() {
    ...
    sb.append("    channelEventNotification: ")
        .append(toIndentedString(channelEventNotification))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
