...
/** EventDeliveryDto */
@JsonPropertyOrder({
  EventDeliveryDto.JSON_PROPERTY_APP_ID,
  EventDeliveryDto.JSON_PROPERTY_ACCEPTED_TIME,
  EventDeliveryDto.JSON_PROPERTY_EVENT_TIME,
  EventDeliveryDto.JSON_PROPERTY_PROJECT_ID,
  EventDeliveryDto.JSON_PROPERTY_MESSAGE_METADATA,
  EventDeliveryDto.JSON_PROPERTY_CORRELATION_ID,
  EventDeliveryDto.JSON_PROPERTY_EVENT_DELIVERY_REPORT
})
...
public class EventDeliveryDto {
  ...
  private EventDeliveryAllOfEventDeliveryReportDto eventDeliveryReport;
  private boolean eventDeliveryReportDefined = false;

  public EventDeliveryDto() {}

  public EventDeliveryDto appId(String appId) {
    this.appId = appId;
  ...
  public EventDeliveryDto acceptedTime(LocalDate acceptedTime) {
  ...
  public EventDeliveryDto eventTime(LocalDate eventTime) {
  ...
  public EventDeliveryDto projectId(String projectId) {
  ...
  public EventDeliveryDto messageMetadata(String messageMetadata) {
  ...
  public EventDeliveryDto correlationId(String correlationId) {
  ...
  public EventDeliveryDto eventDeliveryReport(
      EventDeliveryAllOfEventDeliveryReportDto eventDeliveryReport) {
    this.eventDeliveryReport = eventDeliveryReport;
    this.eventDeliveryReportDefined = true;
    return this;
  }

  /**
   * Get eventDeliveryReport
   *
   * @return eventDeliveryReport
   */
  @JsonProperty(JSON_PROPERTY_EVENT_DELIVERY_REPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public EventDeliveryAllOfEventDeliveryReportDto getEventDeliveryReport() {
    return eventDeliveryReport;
  }

  @JsonIgnore
  public boolean getEventDeliveryReportDefined() {
    return eventDeliveryReportDefined;
  }

  @JsonProperty(JSON_PROPERTY_EVENT_DELIVERY_REPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEventDeliveryReport(EventDeliveryAllOfEventDeliveryReportDto eventDeliveryReport) {
    this.eventDeliveryReport = eventDeliveryReport;
    this.eventDeliveryReportDefined = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventDeliveryDto eventDelivery = (EventDeliveryDto) o;
    return Objects.equals(this.appId, eventDelivery.appId)
        ...
        && Objects.equals(this.eventDeliveryReport, eventDelivery.eventDeliveryReport);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventDeliveryDto {\n");
    ...
    sb.append("    eventDeliveryReport: ")
        .append(toIndentedString(eventDeliveryReport))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
