...
@JsonPropertyOrder({
  DiscountShippingCouponImpl.JSON_PROPERTY_TYPE,
  DiscountShippingCouponImpl.JSON_PROPERTY_DESCRIPTION,
  DiscountShippingCouponImpl.JSON_PROPERTY_LINK_MO,
  DiscountShippingCouponImpl.JSON_PROPERTY_LINK_PC,
  DiscountShippingCouponImpl.JSON_PROPERTY_SCHEME_ANDROID,
  DiscountShippingCouponImpl.JSON_PROPERTY_SCHEME_IOS
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class DiscountShippingCouponImpl
    implements DiscountShippingCoupon,
  ...
  public DiscountShippingCouponImpl() {}

  protected DiscountShippingCouponImpl(
  ...
  /** Return true if this KakaoTalkShippingDiscountCoupon object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    DiscountShippingCouponImpl kakaoTalkShippingDiscountCoupon = (DiscountShippingCouponImpl) o;
    return Objects.equals(this.type, kakaoTalkShippingDiscountCoupon.type)
        && Objects.equals(this.description, kakaoTalkShippingDiscountCoupon.description)
        && Objects.equals(this.linkMo, kakaoTalkShippingDiscountCoupon.linkMo)
        && Objects.equals(this.linkPc, kakaoTalkShippingDiscountCoupon.linkPc)
        && Objects.equals(this.schemeAndroid, kakaoTalkShippingDiscountCoupon.schemeAndroid)
        && Objects.equals(this.schemeIos, kakaoTalkShippingDiscountCoupon.schemeIos);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, description, linkMo, linkPc, schemeAndroid, schemeIos);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiscountShippingCouponImpl {\n");
  ...
  static class Builder implements DiscountShippingCoupon.Builder {
    OptionalValue<TypeEnum> type = OptionalValue.of(TypeEnum.SHIPPING_DISCOUNT_COUPON);
    ...
    Builder setType(TypeEnum type) {
      if (!Objects.equals(type, TypeEnum.SHIPPING_DISCOUNT_COUPON)) {
        throw new IllegalArgumentException(
            String.format(
                "'type' must be '%s' (is '%s')", TypeEnum.SHIPPING_DISCOUNT_COUPON, type));
      }
      return this;
    }
    ...
    public DiscountShippingCoupon build() {
      return new DiscountShippingCouponImpl(
          type, description, linkMo, linkPc, schemeAndroid, schemeIos);
    }
  }
}
