...
@JsonPropertyOrder({ListWebhooksResponseInternalImpl.JSON_PROPERTY_WEBHOOKS})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ListWebhooksResponseInternalImpl implements ListWebhooksResponseInternal {
  ...
  public ListWebhooksResponseInternalImpl() {}

  protected ListWebhooksResponseInternalImpl(OptionalValue<List<Webhook>> webhooks) {
  ...
  public boolean equals(Object o) {
    ...
    ListWebhooksResponseInternalImpl listWebhooksResponse = (ListWebhooksResponseInternalImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class ListWebhooksResponseInternalImpl {\n");
  ...
  static class Builder implements ListWebhooksResponseInternal.Builder {
    ...
    public ListWebhooksResponseInternal build() {
      return new ListWebhooksResponseInternalImpl(webhooks);
    }
  }
}
