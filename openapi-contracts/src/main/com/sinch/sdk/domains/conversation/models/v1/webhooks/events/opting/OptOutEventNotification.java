...
@JsonDeserialize(builder = OptOutEventNotificationImpl.Builder.class)
public interface OptOutEventNotification {
  ...
  public class StatusEnum extends EnumDynamic<String, StatusEnum> {
    public static final StatusEnum SUCCEEDED = new StatusEnum("OPT_OUT_SUCCEEDED");
    public static final StatusEnum FAILED = new StatusEnum("OPT_OUT_FAILED");
    public static final StatusEnum STATUS_UNSPECIFIED =
   ...
   * @return errorDetails
   */
  OptOutEventNotificationErrorDetails getErrorDetails();
  ...
  static Builder builder() {
    return new OptOutEventNotificationImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getErrorDetails
     */
    Builder setErrorDetails(OptOutEventNotificationErrorDetails errorDetails);
