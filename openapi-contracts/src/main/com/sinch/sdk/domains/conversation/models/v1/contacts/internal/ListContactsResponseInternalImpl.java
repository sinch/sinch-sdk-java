...
@JsonPropertyOrder({
  ListContactsResponseInternalImpl.JSON_PROPERTY_CONTACTS,
  ListContactsResponseInternalImpl.JSON_PROPERTY_NEXT_PAGE_TOKEN
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ListContactsResponseInternalImpl implements ListContactsResponseInternal {
  ...
  public ListContactsResponseInternalImpl() {}

  protected ListContactsResponseInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    ListContactsResponseInternalImpl listContactsResponse = (ListContactsResponseInternalImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class ListContactsResponseInternalImpl {\n");
  ...
  static class Builder implements ListContactsResponseInternal.Builder {
    ...
    public ListContactsResponseInternal build() {
      return new ListContactsResponseInternalImpl(contacts, nextPageToken);
    }
  }
}
