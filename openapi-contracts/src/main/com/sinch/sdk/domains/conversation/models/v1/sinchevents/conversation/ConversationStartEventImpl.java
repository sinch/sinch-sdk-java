...
@JsonPropertyOrder({
  ConversationStartEventImpl.JSON_PROPERTY_APP_ID,
  ConversationStartEventImpl.JSON_PROPERTY_ACCEPTED_TIME,
  ConversationStartEventImpl.JSON_PROPERTY_EVENT_TIME,
  ConversationStartEventImpl.JSON_PROPERTY_PROJECT_ID,
  ConversationStartEventImpl.JSON_PROPERTY_MESSAGE_METADATA,
  ConversationStartEventImpl.JSON_PROPERTY_CORRELATION_ID,
  ConversationStartEventImpl.JSON_PROPERTY_CONVERSATION_START_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ConversationStartEventImpl
    implements ConversationStartEvent,
  ...
  public ConversationStartEventImpl() {}

  protected ConversationStartEventImpl(
  ...
  public boolean equals(Object o) {
    ...
    ConversationStartEventImpl conversationStartEvent = (ConversationStartEventImpl) o;
    return Objects.equals(this.appId, conversationStartEvent.appId)
        ...
        && Objects.equals(this.notification, conversationStartEvent.notification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationStartEventImpl {\n");
  ...
  static class Builder implements ConversationStartEvent.Builder {
    ...
    @JsonProperty(value = JSON_PROPERTY_CONVERSATION_START_NOTIFICATION, required = true)
    public Builder setNotification(ConversationNotification notification) {
      this.notification = OptionalValue.of(notification);
      return this;
    }

    public ConversationStartEvent build() {
      return new ConversationStartEventImpl(
          appId, acceptedTime, eventTime, projectId, messageMetadata, correlationId, notification);
    }
  }
}
