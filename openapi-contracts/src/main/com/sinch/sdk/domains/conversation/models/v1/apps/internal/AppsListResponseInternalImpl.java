...
@JsonPropertyOrder({AppsListResponseInternalImpl.JSON_PROPERTY_APPS})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class AppsListResponseInternalImpl implements AppsListResponseInternal {
  ...
  public AppsListResponseInternalImpl() {}

  protected AppsListResponseInternalImpl(OptionalValue<List<AppResponse>> apps) {
    this.apps = apps;
  }
  ...
  public boolean equals(Object o) {
    ...
    AppsListResponseInternalImpl listAppsResponse = (AppsListResponseInternalImpl) o;
  ...
  static class Builder implements AppsListResponseInternal.Builder {
    ...
    public AppsListResponseInternal build() {
      return new AppsListResponseInternalImpl(apps);
    }
  }
}
