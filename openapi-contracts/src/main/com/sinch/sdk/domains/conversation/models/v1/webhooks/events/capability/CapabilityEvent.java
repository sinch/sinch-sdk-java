...
@JsonDeserialize(builder = CapabilityEventImpl.Builder.class)
public interface CapabilityEvent
   ...
   * @return notification
   */
  CapabilityEventNotification getNotification();
  ...
  static Builder builder() {
    return new CapabilityEventImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getNotification
     */
    Builder setNotification(CapabilityEventNotification notification);
