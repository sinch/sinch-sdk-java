...
public interface ConversationsService {
   ...
   * Note that either &#x60;app_id&#x60; or &#x60;contact_id&#x60; is required in order for the
   ...
   *
   * <p>Creates a new empty conversation. In Conversation mode, it is generally not needed to create
   * a conversation explicitly since sending or receiving a message automatically creates a new
