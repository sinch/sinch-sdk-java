 ...
 */
@JsonPropertyOrder({
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_APP_ID,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_ACCEPTED_TIME,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_EVENT_TIME,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_PROJECT_ID,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_MESSAGE_METADATA,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_CORRELATION_ID,
  ContactIdentitiesDuplicationEventDto.JSON_PROPERTY_DUPLICATED_CONTACT_IDENTITIES_NOTIFICATION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class ContactIdentitiesDuplicationEventDto {
  ...
  private DuplicatedIdentitiesEventDto duplicatedContactIdentitiesNotification;
  private boolean duplicatedContactIdentitiesNotificationDefined = false;

  public ContactIdentitiesDuplicationEventDto() {}

  public ContactIdentitiesDuplicationEventDto appId(String appId) {
    this.appId = appId;
  ...
  public ContactIdentitiesDuplicationEventDto acceptedTime(LocalDate acceptedTime) {
  ...
  public ContactIdentitiesDuplicationEventDto eventTime(LocalDate eventTime) {
  ...
  public ContactIdentitiesDuplicationEventDto projectId(String projectId) {
  ...
  public ContactIdentitiesDuplicationEventDto messageMetadata(String messageMetadata) {
  ...
  public ContactIdentitiesDuplicationEventDto correlationId(String correlationId) {
  ...
  public ContactIdentitiesDuplicationEventDto duplicatedContactIdentitiesNotification(
      DuplicatedIdentitiesEventDto duplicatedContactIdentitiesNotification) {
    this.duplicatedContactIdentitiesNotification = duplicatedContactIdentitiesNotification;
    this.duplicatedContactIdentitiesNotificationDefined = true;
    return this;
  }

  /**
   * Get duplicatedContactIdentitiesNotification
   *
   * @return duplicatedContactIdentitiesNotification
   */
  @JsonProperty(JSON_PROPERTY_DUPLICATED_CONTACT_IDENTITIES_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public DuplicatedIdentitiesEventDto getDuplicatedContactIdentitiesNotification() {
    return duplicatedContactIdentitiesNotification;
  }

  @JsonIgnore
  public boolean getDuplicatedContactIdentitiesNotificationDefined() {
    return duplicatedContactIdentitiesNotificationDefined;
  }

  @JsonProperty(JSON_PROPERTY_DUPLICATED_CONTACT_IDENTITIES_NOTIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDuplicatedContactIdentitiesNotification(
      DuplicatedIdentitiesEventDto duplicatedContactIdentitiesNotification) {
    this.duplicatedContactIdentitiesNotification = duplicatedContactIdentitiesNotification;
    this.duplicatedContactIdentitiesNotificationDefined = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContactIdentitiesDuplicationEventDto contactIdentitiesDuplicationEvent =
        (ContactIdentitiesDuplicationEventDto) o;
  ...
  public String toString() {
    ...
    sb.append("class ContactIdentitiesDuplicationEventDto {\n");
