...
@JsonPropertyOrder({
  RecentConversationsListResponseInternalImpl.JSON_PROPERTY_CONVERSATIONS,
  RecentConversationsListResponseInternalImpl.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  RecentConversationsListResponseInternalImpl.JSON_PROPERTY_TOTAL_SIZE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class RecentConversationsListResponseInternalImpl
    implements RecentConversationsListResponseInternal {
  ...
  protected RecentConversationsListResponseInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    RecentConversationsListResponseInternalImpl listRecentConversationsResponse =
        (RecentConversationsListResponseInternalImpl) o;
  ...
  static class Builder implements RecentConversationsListResponseInternal.Builder {
    ...
    public RecentConversationsListResponseInternal build() {
      return new RecentConversationsListResponseInternalImpl(
