...
@JsonPropertyOrder({
  EventDestinationImpl.JSON_PROPERTY_APP_ID,
  EventDestinationImpl.JSON_PROPERTY_CLIENT_CREDENTIALS,
  EventDestinationImpl.JSON_PROPERTY_ID,
  EventDestinationImpl.JSON_PROPERTY_SECRET,
  EventDestinationImpl.JSON_PROPERTY_TARGET,
  EventDestinationImpl.JSON_PROPERTY_TARGET_TYPE,
  EventDestinationImpl.JSON_PROPERTY_TRIGGERS
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class EventDestinationImpl implements EventDestination {
  ...
  public EventDestinationImpl() {}

  protected EventDestinationImpl(
  ...
  public boolean equals(Object o) {
    ...
    EventDestinationImpl webhook = (EventDestinationImpl) o;
  ...
  static class Builder implements EventDestination.Builder {
    ...
    public EventDestination build() {
      return new EventDestinationImpl(
