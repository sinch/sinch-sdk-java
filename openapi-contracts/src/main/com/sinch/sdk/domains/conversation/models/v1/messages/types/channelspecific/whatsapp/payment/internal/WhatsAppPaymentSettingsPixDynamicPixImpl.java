...
@JsonPropertyOrder({
  WhatsAppPaymentSettingsPixDynamicPixImpl.JSON_PROPERTY_CODE,
  WhatsAppPaymentSettingsPixDynamicPixImpl.JSON_PROPERTY_MERCHANT_NAME,
  WhatsAppPaymentSettingsPixDynamicPixImpl.JSON_PROPERTY_KEY,
  WhatsAppPaymentSettingsPixDynamicPixImpl.JSON_PROPERTY_KEY_TYPE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class WhatsAppPaymentSettingsPixDynamicPixImpl
    implements WhatsAppPaymentSettingsPixDynamicPix {
  ...
  public WhatsAppPaymentSettingsPixDynamicPixImpl() {}

  protected WhatsAppPaymentSettingsPixDynamicPixImpl(
  ...
  /** Return true if this WhatsAppPaymentSettingsPix_dynamic_pix object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    WhatsAppPaymentSettingsPixDynamicPixImpl whatsAppPaymentSettingsPixDynamicPix =
        (WhatsAppPaymentSettingsPixDynamicPixImpl) o;
    return Objects.equals(this.code, whatsAppPaymentSettingsPixDynamicPix.code)
        && Objects.equals(this.merchantName, whatsAppPaymentSettingsPixDynamicPix.merchantName)
        && Objects.equals(this.key, whatsAppPaymentSettingsPixDynamicPix.key)
        && Objects.equals(this.keyType, whatsAppPaymentSettingsPixDynamicPix.keyType);
  }
  ...
  public String toString() {
    ...
    sb.append("class WhatsAppPaymentSettingsPixDynamicPixImpl {\n");
  ...
  static class Builder implements WhatsAppPaymentSettingsPixDynamicPix.Builder {
    ...
    public WhatsAppPaymentSettingsPixDynamicPix build() {
      return new WhatsAppPaymentSettingsPixDynamicPixImpl(code, merchantName, key, keyType);
    }
  }
}
