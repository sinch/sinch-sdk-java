...
@JsonPropertyOrder({
  CommentEventInternalImpl.JSON_PROPERTY_ID,
  CommentEventInternalImpl.JSON_PROPERTY_TEXT,
  CommentEventInternalImpl.JSON_PROPERTY_COMMENT_TYPE,
  CommentEventInternalImpl.JSON_PROPERTY_COMMENTED_ON,
  CommentEventInternalImpl.JSON_PROPERTY_USER
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class CommentEventInternalImpl implements CommentEventInternal {
  ...
  public CommentEventInternalImpl() {}

  protected CommentEventInternalImpl(
  ...
  public boolean equals(Object o) {
    ...
    CommentEventInternalImpl commentEvent = (CommentEventInternalImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class CommentEventInternalImpl {\n");
  ...
  static class Builder implements CommentEventInternal.Builder {
    ...
    public CommentEventInternal build() {
      return new CommentEventInternalImpl(id, text, commentType, commentedOn, user);
    }
  }
}
