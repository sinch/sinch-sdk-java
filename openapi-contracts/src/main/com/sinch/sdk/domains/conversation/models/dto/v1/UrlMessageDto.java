...
@JsonPropertyOrder({UrlMessageDto.JSON_PROPERTY_TITLE, UrlMessageDto.JSON_PROPERTY_URL})
...
public class UrlMessageDto {
  ...
  public UrlMessageDto() {}

  public UrlMessageDto title(String title) {
    this.title = title;
  ...
  public UrlMessageDto url(String url) {
    this.url = url;
  ...
  /** Return true if this UrlMessage object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    UrlMessageDto urlMessage = (UrlMessageDto) o;
