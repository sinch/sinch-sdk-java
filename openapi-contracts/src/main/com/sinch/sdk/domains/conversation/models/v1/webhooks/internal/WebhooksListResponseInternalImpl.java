...
@JsonPropertyOrder({WebhooksListResponseInternalImpl.JSON_PROPERTY_WEBHOOKS})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class WebhooksListResponseInternalImpl implements WebhooksListResponseInternal {
  ...
  public WebhooksListResponseInternalImpl() {}

  protected WebhooksListResponseInternalImpl(OptionalValue<List<Webhook>> webhooks) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksListResponseInternalImpl listWebhooksResponse = (WebhooksListResponseInternalImpl) o;
  ...
  static class Builder implements WebhooksListResponseInternal.Builder {
    ...
    public WebhooksListResponseInternal build() {
      return new WebhooksListResponseInternalImpl(webhooks);
    }
  }
}
