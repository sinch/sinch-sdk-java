...
@JsonDeserialize(builder = OptInEventImpl.Builder.class)
public interface OptInEvent
   ...
   * @return notification
   */
  OptInEventNotification getNotification();
  ...
  static Builder builder() {
    return new OptInEventImpl.Builder();
  }
  ...
  interface Builder {
     ...
     * @see #getNotification
     */
    Builder setNotification(OptInEventNotification notification);
