...
/** declaration */
@JsonDeserialize(builder = LineCredentialsFieldImpl.Builder.class)
public interface LineCredentialsField {
  ...
  static Builder builder() {
    return new LineCredentialsFieldImpl.Builder();
  }
