...
@JsonDeserialize(builder = ActiveNumberSinchEventImpl.Builder.class)
public interface ActiveNumberSinchEvent
  ...
  static Builder builder() {
    return new ActiveNumberSinchEventImpl.Builder();
  }
