...
/** NotFoundError */
@JsonDeserialize(builder = NotFoundErrorImpl.Builder.class)
public interface NotFoundError {
  ...
  public class CodeEnum extends EnumDynamic<Integer, CodeEnum> {
    ...
    private static final EnumSupportDynamic<Integer, CodeEnum> ENUM_SUPPORT =
        new EnumSupportDynamic<>(CodeEnum.class, CodeEnum::new, Arrays.asList(NUMBER_404));
  ...
  public class StatusEnum extends EnumDynamic<String, StatusEnum> {
    ...
    private static final EnumSupportDynamic<String, StatusEnum> ENUM_SUPPORT =
        new EnumSupportDynamic<>(StatusEnum.class, StatusEnum::new, Arrays.asList(NOT_FOUND));
  ...
  static Builder builder() {
    return new NotFoundErrorImpl.Builder();
  }
