...
/** ListTemplatesQueryParameters */
public interface ListTemplatesQueryParameters {
  ...
  static Builder builder() {
    return new ListTemplatesQueryParametersImpl.Builder();
  }
   ...
   * @return New Builder instance
   */
  static Builder builder(ListTemplatesQueryParameters parameters) {
    return new ListTemplatesQueryParametersImpl.Builder(parameters);
  }
  ...
  interface Builder {
     ...
     */
    ListTemplatesQueryParameters build();
  }
}
