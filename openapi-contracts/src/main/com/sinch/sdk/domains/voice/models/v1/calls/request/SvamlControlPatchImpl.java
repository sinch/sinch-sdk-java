...
@JsonPropertyOrder({
  SvamlControlPatchImpl.JSON_PROPERTY_INSTRUCTIONS,
  SvamlControlPatchImpl.JSON_PROPERTY_ACTION
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class SvamlControlPatchImpl
    implements SvamlControlPatch, com.sinch.sdk.domains.voice.models.v1.svaml.Control {
  ...
  public SvamlControlPatchImpl() {}

  protected SvamlControlPatchImpl(
  ...
  /** Return true if this UpdateCallSVAMLRequestBody object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    SvamlControlPatchImpl updateCallSVAMLRequestBody = (SvamlControlPatchImpl) o;
    return Objects.equals(this.instructions, updateCallSVAMLRequestBody.instructions)
        && Objects.equals(this.action, updateCallSVAMLRequestBody.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class SvamlControlPatchImpl {\n");
  ...
  static class Builder implements SvamlControlPatch.Builder {
    ...
    public SvamlControlPatch build() {
      return new SvamlControlPatchImpl(instructions, action);
    }
  }
}
