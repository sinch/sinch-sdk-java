...
public interface CallsService {
   ...
   * @param svamlControlPatch (optional)
   * @throws ApiException if fails to make API call
   */
  void manageWithCallLeg(String callId, CallLeg callLeg, SvamlControlPatch svamlControlPatch)
      throws ApiException;
   ...
   * @throws ApiException if fails to make API call
   */
  void update(String callId, SvamlControlPatch svamlControlPatch) throws ApiException;
}
