 ...
 */
@JsonDeserialize(builder = TtsCalloutInternalImpl.Builder.class)
public interface TtsCalloutInternal {
  ...
  static Builder builder() {
    return new TtsCalloutInternalImpl.Builder();
  }
