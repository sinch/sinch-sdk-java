...
public class AnsweredCallEventImpl
    implements AnsweredCallEvent, VoiceSinchEvent, VoiceCallSinchEvent {
  ...
  static class Builder implements AnsweredCallEvent.Builder {
    ...
    OptionalValue<SinchEventType> event = OptionalValue.of(SinchEventType.ACE);
    ...
    Builder setEvent(SinchEventType event) {
      if (!Objects.equals(event, SinchEventType.ACE)) {
        throw new IllegalArgumentException(
            String.format("'event' must be '%s' (is '%s')", SinchEventType.ACE, event));
      }
      return this;
    }
