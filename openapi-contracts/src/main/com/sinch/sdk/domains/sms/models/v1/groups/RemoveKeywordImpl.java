...
@JsonPropertyOrder({
  RemoveKeywordImpl.JSON_PROPERTY_FIRST_WORD,
  RemoveKeywordImpl.JSON_PROPERTY_SECOND_WORD
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class RemoveKeywordImpl implements RemoveKeyword {
  ...
  public RemoveKeywordImpl() {}

  protected RemoveKeywordImpl(OptionalValue<String> firstWord, OptionalValue<String> secondWord) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveKeywordImpl removeKeyword = (RemoveKeywordImpl) o;
  ...
  public String toString() {
    ...
    sb.append("class RemoveKeywordImpl {\n");
  ...
  static class Builder implements RemoveKeyword.Builder {
    ...
    public RemoveKeyword build() {
      return new RemoveKeywordImpl(firstWord, secondWord);
    }
  }
}
