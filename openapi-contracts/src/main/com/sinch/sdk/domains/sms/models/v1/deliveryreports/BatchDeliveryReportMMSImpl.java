...
@JsonPropertyOrder({
  BatchDeliveryReportMMSImpl.JSON_PROPERTY_BATCH_ID,
  BatchDeliveryReportMMSImpl.JSON_PROPERTY_CLIENT_REFERENCE,
  BatchDeliveryReportMMSImpl.JSON_PROPERTY_STATUSES,
  BatchDeliveryReportMMSImpl.JSON_PROPERTY_TOTAL_MESSAGE_COUNT,
  BatchDeliveryReportMMSImpl.JSON_PROPERTY_TYPE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class BatchDeliveryReportMMSImpl implements BatchDeliveryReportMMS, BatchDeliveryReport {
  private static final long serialVersionUID = 1L;

  /** Gets or Sets type */
  public static class TypeEnum extends EnumDynamic<String, TypeEnum> {
    public static final TypeEnum DELIVERY_REPORT_MMS = new TypeEnum("delivery_report_mms");

    private static final EnumSupportDynamic<String, TypeEnum> ENUM_SUPPORT =
        new EnumSupportDynamic<>(TypeEnum.class, TypeEnum::new, Arrays.asList(DELIVERY_REPORT_MMS));
  ...
  public BatchDeliveryReportMMSImpl() {}

  protected BatchDeliveryReportMMSImpl(
  ...
  /** Return true if this BatchDeliveryReportMMS object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    BatchDeliveryReportMMSImpl batchDeliveryReportMMS = (BatchDeliveryReportMMSImpl) o;
    return Objects.equals(this.batchId, batchDeliveryReportMMS.batchId)
        && Objects.equals(this.clientReference, batchDeliveryReportMMS.clientReference)
        && Objects.equals(this.statuses, batchDeliveryReportMMS.statuses)
        && Objects.equals(this.totalMessageCount, batchDeliveryReportMMS.totalMessageCount)
        && Objects.equals(this.type, batchDeliveryReportMMS.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchDeliveryReportMMSImpl {\n");
  ...
  static class Builder implements BatchDeliveryReportMMS.Builder {
    ...
    OptionalValue<TypeEnum> type = OptionalValue.of(TypeEnum.DELIVERY_REPORT_MMS);
