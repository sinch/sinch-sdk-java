...
@JsonPropertyOrder({
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_ID,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_STATUS,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_REASON,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_REFERENCE,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_IDENTITY,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_COUNTRY_ID,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_VERIFICATION_TIMESTAMP,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_METHOD,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_PRICE,
  VerificationStatusResponseWhatsAppImpl.JSON_PROPERTY_SOURCE
})
@JsonFilter("uninitializedFilter")
@JsonInclude(value = JsonInclude.Include.CUSTOM)
public class VerificationStatusResponseWhatsAppImpl
    implements VerificationStatusResponseWhatsApp,
  ...
  public VerificationStatusResponseWhatsAppImpl() {}

  protected VerificationStatusResponseWhatsAppImpl(
  ...
  /** Return true if this VerificationStatusResponseWhatsApp object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    VerificationStatusResponseWhatsAppImpl verificationStatusResponseWhatsApp =
        (VerificationStatusResponseWhatsAppImpl) o;
    return Objects.equals(this.id, verificationStatusResponseWhatsApp.id)
        && Objects.equals(this.status, verificationStatusResponseWhatsApp.status)
        && Objects.equals(this.reason, verificationStatusResponseWhatsApp.reason)
        && Objects.equals(this.reference, verificationStatusResponseWhatsApp.reference)
        && Objects.equals(this.identity, verificationStatusResponseWhatsApp.identity)
        && Objects.equals(this.countryId, verificationStatusResponseWhatsApp.countryId)
        && Objects.equals(
            this.verificationTimestamp, verificationStatusResponseWhatsApp.verificationTimestamp)
        && Objects.equals(this.method, verificationStatusResponseWhatsApp.method)
        && Objects.equals(this.price, verificationStatusResponseWhatsApp.price)
        && Objects.equals(this.source, verificationStatusResponseWhatsApp.source);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerificationStatusResponseWhatsAppImpl {\n");
  ...
  static class Builder implements VerificationStatusResponseWhatsApp.Builder {
    ...
    public VerificationStatusResponseWhatsApp build() {
      return new VerificationStatusResponseWhatsAppImpl(
          id,
          status,
          reason,
          reference,
