...
/**
 * With the SMS verification method, a user's phone number is verified by sending an SMS containing
 * an OTP code that must be manually returned. If you are are using an Android handset, you could
 * instead intercept the SMS message delivery and capture the OTP code automatically.
 */
