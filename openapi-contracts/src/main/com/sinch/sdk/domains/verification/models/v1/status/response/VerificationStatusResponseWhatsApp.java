...
/** WhatsApp Verification Status Response */
@JsonDeserialize(builder = VerificationStatusResponseWhatsAppImpl.Builder.class)
public interface VerificationStatusResponseWhatsApp
  ...
  /** The method of the verification request. This will always be <code>whatsapp</code>. */
  ...
  static Builder builder() {
    return new VerificationStatusResponseWhatsAppImpl.Builder();
  }
  ...
  interface Builder {
     ...
     */
    VerificationStatusResponseWhatsApp build();
  }
}
