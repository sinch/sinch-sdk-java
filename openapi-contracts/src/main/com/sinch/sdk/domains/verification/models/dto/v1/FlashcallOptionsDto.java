...
/** FlashcallOptionsDto */
@JsonPropertyOrder({
  FlashcallOptionsDto.JSON_PROPERTY_CLI,
  FlashcallOptionsDto.JSON_PROPERTY_CLI_EXTRA_DIGITS,
...
public class FlashcallOptionsDto {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getCliExtraDigits() {
    return cliExtraDigits;
  }
  ...
  public boolean equals(Object o) {
    ...
    FlashcallOptionsDto flashcallOptions = (FlashcallOptionsDto) o;
    return Objects.equals(this.cli, flashcallOptions.cli)
        && Objects.equals(this.cliExtraDigits, flashcallOptions.cliExtraDigits)
        && Objects.equals(this.dialTimeout, flashcallOptions.dialTimeout)
        && Objects.equals(this.interceptionTimeout, flashcallOptions.interceptionTimeout);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cli, cliExtraDigits, dialTimeout, interceptionTimeout);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlashcallOptionsDto {\n");
