...
/** SimSwapResourceDto */
@JsonPropertyOrder({SimSwapResourceDto.JSON_PROPERTY_NUMBER})
...
public class SimSwapResourceDto {
  ...
  public SimSwapResourceDto number(String number) {
    this.number = number;
  ...
  /**
   * MSISDN to verify with sim swamp service.
   *
   * @return number
   */
  ...
  /** Return true if this SimSwapResource object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    SimSwapResourceDto simSwapResource = (SimSwapResourceDto) o;
    return Objects.equals(this.number, simSwapResource.number);
  }
  ...
  public String toString() {
    ...
    sb.append("class SimSwapResourceDto {\n");
