...
public class QueryVerificationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public VerificationResponseDto verificationStatusByIdentity(
    ...
    HttpRequest httpRequest = verificationStatusByIdentityRequestBuilder(type, endpoint, method);
    HttpResponse response =
        httpClient.invokeAPI(
            this.serverConfiguration, this.authManagersByOasSecuritySchemes, httpRequest);
  ...
  private HttpRequest verificationStatusByIdentityRequestBuilder(
      String type, String endpoint, String method) throws ApiException {
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(
          400, "Missing the required parameter 'type' when calling verificationStatusByIdentity");
    }
