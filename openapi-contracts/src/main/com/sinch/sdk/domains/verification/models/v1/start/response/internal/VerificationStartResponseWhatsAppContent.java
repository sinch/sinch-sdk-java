...
/** The response contains the <code>codeType</code> property. */
@JsonDeserialize(builder = VerificationStartResponseWhatsAppContentImpl.Builder.class)
public interface VerificationStartResponseWhatsAppContent extends AdditionalProperties {
  ...
  static Builder builder() {
    return new VerificationStartResponseWhatsAppContentImpl.Builder();
  }
  ...
  interface Builder extends AdditionalProperties.Builder {
     ...
     */
    VerificationStartResponseWhatsAppContent build();
  }
}
