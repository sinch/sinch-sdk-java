...
@TestWithResources
public class ContactDeleteEventDtoTest extends ConversationBaseTest {

  @GivenJsonResource("domains/conversation/v1/webhooks/events/contact/ContactDeleteEventDto.json")
  ...
  public static ConversationEventInternal expectedEventDto =
      new ConversationEventInternalImpl(
          (ContactDeleteEventImpl)
              ContactDeleteEvent.builder()
