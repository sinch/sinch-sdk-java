...
public class PaymentStatusUpdateEventDtoTest extends ConversationBaseTest {
  ...
  PaymentStatusUpdateEvent dtoPaymentStatusUpdateEventDto;
  ...
  public static PaymentStatusUpdateEvent expectedPaymentStatusUpdateEventDto =
      PaymentStatusUpdateEvent.builder()
          ...
          .setPaymentStatus(PaymentStatus.PAYMENT_STATUS_CAPTURED)
          .setPaymentTransactionStatus(PaymentTransactionStatus.PAYMENT_STATUS_TRANSACTION_PENDING)
  ...
  void deserialize() {
    TestHelpers.recursiveEquals(
        dtoPaymentStatusUpdateEventDto, expectedPaymentStatusUpdateEventDto);
  }
}
