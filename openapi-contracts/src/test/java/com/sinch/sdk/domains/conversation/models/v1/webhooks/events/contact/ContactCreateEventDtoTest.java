...
@TestWithResources
public class ContactCreateEventDtoTest extends ConversationBaseTest {

  @GivenJsonResource("domains/conversation/v1/webhooks/events/contact/ContactCreateEventDto.json")
