...
@TestWithResources
public class EventComposingEndDtoTest extends ConversationBaseTest {

  @GivenJsonResource("domains/conversation/v1/events/EventComposingEndDto.json")
  EventComposingEnd dto;

  @GivenTextResource("domains/conversation/v1/events/EventComposingEndDto.json")
  String json;

  public static EventComposingEnd expectedDto = EventComposingEnd.EMPTY;
