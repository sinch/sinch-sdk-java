...
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.inbound.Event.DirectionEnum;
...
public class InboundEventDtoTest extends ConversationBaseTest {
  ...
  @GivenJsonResource("domains/conversation/v1/sinchevents/inbound/InboundContactEventDto.json")
  ...
  @GivenJsonResource(
      "domains/conversation/v1/sinchevents/inbound/InboundContactMessageEventDto.json")
