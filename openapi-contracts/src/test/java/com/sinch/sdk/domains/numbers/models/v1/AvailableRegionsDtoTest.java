...
public class AvailableRegionsDtoTest extends NumbersBaseTest {
  ...
  public static AvailableRegionsListResponseInternal availableRegionList =
      AvailableRegionsListResponseInternal.builder()
  ...
  void deserializeList() throws JsonProcessingException {
    ...
    AvailableRegionsListResponseInternal deserializedString =
        objectMapper.readValue(availableListResponse, AvailableRegionsListResponseInternal.class);
