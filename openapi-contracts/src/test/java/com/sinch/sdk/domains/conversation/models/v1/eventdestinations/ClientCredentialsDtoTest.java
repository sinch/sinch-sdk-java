...
import com.sinch.sdk.domains.conversation.models.v1.eventdestinations.ClientCredentials.TokenRequestTypeEnum;
...
public class ClientCredentialsDtoTest extends ConversationBaseTest {
  ...
  @GivenJsonResource("domains/conversation/v1/eventdestinations/ClientCredentialsDto.json")
  ClientCredentials dto;

  @GivenTextResource("/domains/conversation/v1/eventdestinations/ClientCredentialsDto.json")
  String json;
