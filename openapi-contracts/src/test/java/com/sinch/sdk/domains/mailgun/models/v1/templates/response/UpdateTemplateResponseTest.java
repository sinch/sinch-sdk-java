...
@TestWithResources
public class UpdateTemplateResponseTest extends BaseTest {

  @GivenJsonResource("/domains/mailgun/v1/templates/response/UpdateTemplateResponseDto.json")
  ...
  public static UpdateResponseInternal expectedResponse =
      UpdateResponseInternal.builder()
          .setMessage("template has been updated")
          .setTemplate(
