...
import com.sinch.sdk.domains.conversation.models.v1.contacts.internal.ListContactsResponseInternal;
import com.sinch.sdk.domains.conversation.models.v1.contacts.internal.ListIdentityConflictsResponseInternal;
...
public class ContactDtoTest extends ConversationBaseTest {
  ...
  ListContactsResponseInternal loadedContactListResponseDtoPage0;

  @GivenJsonResource("/domains/conversation/v1/contacts/ContactListResponseDtoPage1.json")
  ListContactsResponseInternal loadedContactListResponseDtoPage1;
  ...
  ListIdentityConflictsResponseInternal loadedListIdentityConflictsResponseDtoPage0;

  @GivenJsonResource("/domains/conversation/v1/contacts/ListIdentityConflictsResponseDtoPage1.json")
  ListIdentityConflictsResponseInternal loadedListIdentityConflictsResponseDtoPage1;
  ...
  public static Contact expectedContactResponseDto =
      Contact.builder()
          ...
          .setLanguage(ContactLanguage.AR)
          .build();
  public static ListContactsResponseInternal expectedContactListResponseDtoPage0 =
      ListContactsResponseInternal.builder()
          .setContacts(Collections.singletonList(expectedContactsListItemResponseDto))
          .setNextPageToken("the next page token value")
          .build();
  public static ListContactsResponseInternal expectedContactListResponseDtoPage1 =
      ListContactsResponseInternal.builder()
  ...
  public static ListIdentityConflictsResponseInternal
      expectedListIdentityConflictsResponseDtoPage0 =
          ListIdentityConflictsResponseInternal.builder()
