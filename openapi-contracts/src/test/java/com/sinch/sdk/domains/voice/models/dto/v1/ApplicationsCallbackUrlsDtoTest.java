...
public class ApplicationsCallbackUrlsDtoTest extends BaseTest {
  ...
  @GivenJsonResource("/domains/voice/v1/ApplicationsGetCallbackUrlsResponseDto.json")
  CallbacksDto loaded;

  @GivenTextResource("/domains/voice/v1/ApplicationsGetCallbackUrlsRequestDto.json")
  String jsonRequest;
