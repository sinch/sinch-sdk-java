...
public class ContactMergeEventDtoTest extends ConversationBaseTest {
  ...
  @GivenJsonResource("domains/conversation/v1/sinchevents/contact/ContactMergeEventDto.json")
              ...
              ContactMergeEvent.builder()
                  ...
                  .setNotification(
                      ContactMergeEventNotification.builder()
                          .setPreservedContact(ContactDtoTest.expectedContactsListItemResponseDto)
                          .setDeletedContact(ContactDtoTest.expectedContactResponseDto)
                          .build())
                  .build());
