...
public class ShortLinkActivatedEventDtoTest extends ConversationBaseTest {
  ...
  @GivenJsonResource(
      "domains/conversation/v1/events/contactmessage/ShortLinkActivatedEventDto.json")
  ContactMessageEventInternalImpl dtoShortLinkActivatedEventDto;
  ...
  void deserialize() {
    TestHelpers.recursiveEquals(
        dtoShortLinkActivatedEventDto.getShortLinkActivatedEventImpl(),
        expectedShortLinkActivatedEventDto);
  }
}
