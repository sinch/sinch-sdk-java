...
public class PurgeSendingQueue {
  ...
  public static void main(String[] args) {
    ...
    String storageHostToBePurged = "A_STORAGE_HOST_TO_BE_PURGED";
    ...
    LOGGER.info(String.format("Purge domain '%s'", mailgunDomain));

    emailsService.purgeSendingQueue(mailgunDomain, storageHostToBePurged);
