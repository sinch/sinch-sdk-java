...
public class ListAuditRecords {

  private static final Logger LOGGER = Logger.getLogger(ListAuditRecords.class.getName());
  ...
  public static void main(String[] args) {
    ...
    // The identity to retrieve audit records for (e.g. a phone number)
    String identity = "MY_IDENTITY";
    ...
    LOGGER.info(String.format("List audit records for identity '%s' in app '%s'", identity, appId));

    AuditRecordsResponse response = consentsService.listAuditRecords(appId, identity);
