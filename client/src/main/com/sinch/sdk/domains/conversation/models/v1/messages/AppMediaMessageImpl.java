...
public class AppMediaMessageImpl extends AppMessageImpl<MediaMessage> implements AppMediaMessage {

  private AppMediaMessageImpl(
      OptionalValue<MediaMessage> message,
  ...
  /** Dedicated Builder */
  public static class Builder extends AppMessageImpl.Builder<MediaMessage>
      implements AppMediaMessage.Builder {}
}
