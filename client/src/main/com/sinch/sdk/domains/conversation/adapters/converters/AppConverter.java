...
import com.sinch.sdk.domains.conversation.models.dto.v1.AppResponseMessageSearchDto;
...
public class AppConverter {
  ...
  public static App convert(AppResponseDto dto) {
    ...
    return App.builder()
        ...
        .setMessageSearch(convert(dto.getMessageSearch()))
  ...
  private static MessageSearch convert(AppResponseMessageSearchDto dto) {
    if (null == dto) {
      return null;
    }
