...
import com.sinch.sdk.domains.conversation.models.v1.messages.types.choice.ChoiceImpl;
...
import com.sinch.sdk.domains.conversation.models.v1.messages.types.location.DelegatedMapper.DelegatedLocationDeSerializer;
import com.sinch.sdk.domains.conversation.models.v1.messages.types.location.DelegatedMapper.DelegatedLocationSerializer;
import com.sinch.sdk.domains.conversation.models.v1.messages.types.location.LocationMessage;
import com.sinch.sdk.domains.conversation.models.v1.messages.types.text.DelegatedMapper.DelegatedTextSerializer;
...
public class ChoiceMessageOneOfInternalMapper {
  ...
  public static void initMapper() {
    ...
    Mapper.getInstance()
        ...
        .addMixIn(ChoiceMessageOneOfInternalImpl.Builder.class, ChoiceMixinDeserializer.class)
  ...
  static class ChoiceMixinDeserializer extends ChoiceMessageOneOfInternalImpl.Builder {

    @Override
    @JsonDeserialize(using = ChoiceMixinTextDeSerializer.class)
    public ChoiceMessageOneOfInternalImpl.Builder setTextMessage(TextMessage message) {
      return super.setTextMessage(message);
    }

    @Override
    @JsonDeserialize(using = DelegatedLocationDeSerializer.class)
    public ChoiceMessageOneOfInternalImpl.Builder setLocationMessage(LocationMessage message) {
      return super.setLocationMessage(message);
    }
  }

  static class ChoiceMessageMixinDeserializer extends ChoiceMessageOneOfInternalImpl.Builder {
