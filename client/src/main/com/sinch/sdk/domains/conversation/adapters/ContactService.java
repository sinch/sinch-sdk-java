...
public class ContactService implements com.sinch.sdk.domains.conversation.ContactService {
  ...
  public ContactListResponse list(ContactListRequestParameters iclient) throws ApiException {
    ...
    ListContactsResponseDto response =
        getApi()
            .contactListContacts(
                configuration.getProjectId(), pageSize, pageToken, externalId, channel, identity);
  ...
  public Contact get(String contactId) {
    return ContactDtoConverter.convert(
        getApi().contactGetContact(configuration.getProjectId(), contactId));
  }
    ...
    return ContactDtoConverter.convert(
        getApi()
            .contactCreateContact(
                configuration.getProjectId(), ContactDtoConverter.convertForCreate(client)));
  }

  public void delete(String contactId) {

    getApi().contactDeleteContact(configuration.getProjectId(), contactId);
  }
