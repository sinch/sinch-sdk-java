...
public class AppContactInfoMessageImpl extends AppMessageImpl<ContactInfoMessage>
    implements AppContactInfoMessage {

  private AppContactInfoMessageImpl(
      OptionalValue<ContactInfoMessage> message,
  ...
  /** Dedicated Builder */
  public static class Builder extends AppMessageImpl.Builder<ContactInfoMessage>
      implements AppContactInfoMessage.Builder {}
}
