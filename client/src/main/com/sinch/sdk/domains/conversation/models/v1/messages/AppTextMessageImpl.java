...
public class AppTextMessageImpl extends AppMessageImpl<TextMessage> implements AppTextMessage {

  private AppTextMessageImpl(
  ...
  /** Dedicated Builder */
  public static class Builder extends AppMessageImpl.Builder<TextMessage>
      implements AppTextMessage.Builder {}
}
