 ...
 * @since 1.0
 * @deprecated use {@link com.sinch.sdk.domains.voice.api.v1.CallsService} instead.
 */
@Deprecated
public interface CallsService {
   ...
   * @deprecated use {@link com.sinch.sdk.domains.voice.api.v1.CallsService#get(String)} instead.
   */
  @Deprecated
   ...
   * @deprecated use {@link com.sinch.sdk.domains.voice.api.v1.CallsService#update(String,
   *     SvamlControl)} instead.
   */
  @Deprecated
   ...
   * @param parameters Tasks to be used related to this call
   * @deprecated use {@link
   *     com.sinch.sdk.domains.voice.api.v1.CallsService#manageWithCallLeg(String, CallLeg,
   *     SvamlControl)} instead.
   */
  @Deprecated
