...
public interface BatchesService {
  ...
  ListBatchesResponse list(ListBatchesQueryParameters parameters) throws ApiException;

  DryRunResponse dryRun(DryRunQueryParameters queryParameters, BatchRequest batch);
