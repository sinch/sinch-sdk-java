...
public class EventDestinationsSteps {
  ...
  EventDestination createResponse;

  EventDestinationsListResponse listResponse;
  EventDestination getResponse;
  EventDestination updateResponse;
  boolean deletePassed;

  @Given("^the Conversation service \"Webhooks\" is available$")
  public void serviceAvailable() {
    service = Config.getSinchClient().conversation().v1().eventDestinations();
  }

  @When("^I send a request to create a conversation webhook$")
  public void create() {

    EventDestinationCreateRequest request =
        EventDestinationCreateRequest.builder()
            .setAppId(AppsSteps.APP_ID)
            .setTarget("https://my-callback-server.com/capability")
            .setTriggers(Collections.singletonList(EventDestinationTrigger.CAPABILITY))
        ...
        EventDestination.builder()
            ...
            .setTriggers(
                Arrays.asList(
                    ...
                    EventDestinationTrigger.OPT_IN,
                    EventDestinationTrigger.OPT_OUT))
  ...
  public void createResult() {
    ...
    Assertions.assertEquals(
        createResponse.getTriggers().get(0), EventDestinationTrigger.CAPABILITY);
  ...
  public void listResult() {
    ...
    Assertions.assertEquals(
        ...
        Arrays.asList(
            ...
            EventDestinationTrigger.CONTACT_DELETE,
            EventDestinationTrigger.CONTACT_IDENTITIES_DUPLICATION,
            EventDestinationTrigger.CONTACT_MERGE,
            EventDestinationTrigger.CONTACT_UPDATE));
  ...
  public void getResult() {
    EventDestination expected =
        EventDestination.builder()
            ...
            .setTriggers(Collections.singletonList(EventDestinationTrigger.UNSUPPORTED))
