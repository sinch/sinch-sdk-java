...
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.delivery.DeliveryStatus;
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.delivery.EventDeliveryReceiptEvent;
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.delivery.EventDeliveryReport;
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.delivery.MessageDeliveryReceiptEvent;
import com.sinch.sdk.domains.conversation.models.v1.sinchevents.delivery.MessageDeliveryReport;
...
public class SinchEventsSteps {
  ...
  Map<EventDestinationTrigger, Class<?>> expectedClasses =
      Stream.of(
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CAPABILITY, CapabilityEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_CREATE, ContactCreateEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_DELETE, ContactDeleteEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_MERGE, ContactMergeEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_UPDATE, ContactUpdateEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_DELETE, ConversationDeleteEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_START, ConversationStartEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_STOP, ConversationStopEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.EVENT_DELIVERY, EventDeliveryReceiptEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.EVENT_INBOUND, InboundEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_DELIVERY, MessageDeliveryReceiptEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_INBOUND, MessageInboundEvent.class),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_INBOUND_SMART_CONVERSATION_REDACTION,
                  MessageInboundSmartConversationRedactionEvent.class))
          .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

  Map<EventDestinationTrigger, String> triggerToURL =
      Stream.of(
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CAPABILITY, WEBHOOKS_PATH + "capability-lookup"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_CREATE, WEBHOOKS_PATH + "contact-create"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_DELETE, WEBHOOKS_PATH + "contact-delete"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_MERGE, WEBHOOKS_PATH + "contact-merge"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONTACT_UPDATE, WEBHOOKS_PATH + "contact-update"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_DELETE,
                  WEBHOOKS_PATH + "conversation-delete"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_START, WEBHOOKS_PATH + "conversation-start"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.CONVERSATION_STOP, WEBHOOKS_PATH + "conversation-stop"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.EVENT_DELIVERY,
                  WEBHOOKS_PATH + "event-delivery-report/succeeded"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.EVENT_INBOUND, WEBHOOKS_PATH + "event-inbound"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_DELIVERY,
                  WEBHOOKS_PATH + "message-delivery-report/succeeded"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_INBOUND, WEBHOOKS_PATH + "message-inbound"),
              new AbstractMap.SimpleEntry<>(
                  EventDestinationTrigger.MESSAGE_INBOUND_SMART_CONVERSATION_REDACTION,
  ...
  Map<EventDestinationTrigger, WebhooksHelper.Response<ConversationSinchEvent>> receivedEvents =
      new ConcurrentHashMap<>();

  WebhooksHelper.Response<ConversationSinchEvent> eventDeliveryReceiptFailedResponse;
  WebhooksHelper.Response<ConversationSinchEvent> messageDeliveryReceiptFailedResponse;
  WebhooksHelper.Response<ConversationSinchEvent> messageSubmitMediaResponse;
  WebhooksHelper.Response<ConversationSinchEvent> messageSubmitTextResponse;
  WebhooksHelper.Response<ConversationSinchEvent> smartConversationMediaResponse;
  WebhooksHelper.Response<ConversationSinchEvent> smartConversationTextResponse;

  @Given("^the Conversation Webhooks handler is available$")
  public void handlerAvailable() {
    service = Config.getSinchClient().conversation().v1().sinchEvents();
  }

  @When("^I send a request to trigger a \"CAPABILITY\" event$")
  public void triggerCAPABILITY() throws IOException {
    handleRequest(EventDestinationTrigger.CAPABILITY);
  }

  @When("^I send a request to trigger a \"CONTACT_CREATE\" event$")
  public void triggerCONTACT_CREATE() throws IOException {
    handleRequest(EventDestinationTrigger.CONTACT_CREATE);
  }

  @When("^I send a request to trigger a \"CONTACT_DELETE\" event$")
  public void triggerCONTACT_DELETE() throws IOException {
    handleRequest(EventDestinationTrigger.CONTACT_DELETE);
  }

  @When("^I send a request to trigger a \"CONTACT_MERGE\" event$")
  public void triggerCONTACT_MERGE() throws IOException {
    handleRequest(EventDestinationTrigger.CONTACT_MERGE);
  }

  @When("^I send a request to trigger a \"CONTACT_UPDATE\" event$")
  public void triggerCONTACT_UPDATE() throws IOException {
    handleRequest(EventDestinationTrigger.CONTACT_UPDATE);
  }

  @When("^I send a request to trigger a \"CONVERSATION_DELETE\" event$")
  public void triggerCONVERSATION_DELETE() throws IOException {
    handleRequest(EventDestinationTrigger.CONVERSATION_DELETE);
  }

  @When("^I send a request to trigger a \"CONVERSATION_START\" event$")
  public void triggerCONVERSATION_START() throws IOException {
    handleRequest(EventDestinationTrigger.CONVERSATION_START);
  }

  @When("^I send a request to trigger a \"CONVERSATION_STOP\" event$")
  public void triggerCONVERSATION_STOP() throws IOException {
    handleRequest(EventDestinationTrigger.CONVERSATION_STOP);
  }
  ...
  public void triggerEVENT_DELIVERY() throws IOException {
    handleRequest(EventDestinationTrigger.EVENT_DELIVERY);
  }

  @When("^I send a request to trigger a \"EVENT_INBOUND\" event$")
  public void triggerINBOUND() throws IOException {
    handleRequest(EventDestinationTrigger.EVENT_INBOUND);
  }
  ...
  public void triggerMESSAGE_INBOUND_SMART_CONVERSATION_REDACTION() throws IOException {
    handleRequest(EventDestinationTrigger.MESSAGE_INBOUND_SMART_CONVERSATION_REDACTION);
  }
  ...
  public void validateHeader(String e2eKeyword) {
    ...
    WebhooksHelper.Response<ConversationSinchEvent> receivedEvent =
        receivedEvents.get(EventDestinationTrigger.from(e2eKeyword));
  ...
  public void triggerResult(String e2eKeyword) {
    EventDestinationTrigger trigger = EventDestinationTrigger.from(e2eKeyword);
    WebhooksHelper.Response<ConversationSinchEvent> receivedEvent = receivedEvents.get(trigger);
    if (null != receivedEvent) {
  ...
  public void validateEventDeliveryFailureHeader(String e2eKeyword, String status) {
    ...
    WebhooksHelper.Response<ConversationSinchEvent> receivedEvent = null;
    if (e2eKeyword.equals(EventDestinationTrigger.EVENT_DELIVERY.value())
        && status.equals(DeliveryStatus.FAILED.value())) {
      receivedEvent = eventDeliveryReceiptFailedResponse;
    } else if (e2eKeyword.equals(EventDestinationTrigger.EVENT_DELIVERY.value())
        && status.equals(DeliveryStatus.DELIVERED.value())) {
      receivedEvent = receivedEvents.get(EventDestinationTrigger.from(e2eKeyword));
    } else if (e2eKeyword.equals(EventDestinationTrigger.MESSAGE_DELIVERY.value())
        && status.equals(DeliveryStatus.FAILED.value())) {
  ...
  public void handleRequest(EventDestinationTrigger trigger) throws IOException {

    WebhooksHelper.Response<ConversationSinchEvent> response =
