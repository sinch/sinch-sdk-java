...
import com.sinch.sdk.domains.mailgun.models.v1.templates.response.GetTemplateResponse;
...
class TemplatesServiceTest extends BaseTest {
  ...
  @GivenJsonResource("/domains/mailgun/v1/templates/response/ListTemplatesResponseDtoPage2.json")
  ListTemplatesResponseInternal listTemplatesResponseDtoPage2;
  ...
  void get() {
    ...
    GetTemplateResponse response = service.get(domainName, templateName);

    TestHelpers.recursiveEquals(response, GetTemplateResponseTest.expectedTemplate);
  }
  ...
  void list() throws ApiException {
    ...
    HttpRequest httpRequest2 =
        new HttpRequest(
            "https://api.mailgun.net/v3/sandbox7cebd4de7e914658a284dda3e6a845e2.mailgun.org/templates?page=next&p=template.test&limit=2",
            HttpMethod.GET,
            null,
            Collections.emptyMap(),
            Collections.singletonList(HttpContentType.APPLICATION_JSON),
