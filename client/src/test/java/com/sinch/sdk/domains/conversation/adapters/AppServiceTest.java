...
public class AppServiceTest extends BaseTest {
  ...
  void list() throws ApiException {
    ...
    when(api.appListApps(eq(configuration.getProjectId())))
  ...
  void get() throws ApiException {
    ...
    when(api.appGetApp(
            eq(configuration.getProjectId()), eq(AppDtoTest.expectedAppsResponseDto.getId())))
  ...
  void create() throws ApiException {
    ...
    when(api.appCreateApp(eq(configuration.getProjectId()), eq(AppDtoTest.appCreateRequestDto)))
        .thenReturn(AppDtoTest.expectedAppsResponseDto);
